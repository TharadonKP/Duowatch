                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>ProductID</th><th>ProductName</th><th>Price</th><th>Image</th><th>Actions</th>
                                ...
                                @foreach($product as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->productID }}</td><td>{{ $item->productName }}</td><td>{{ $item->price }}</td>
                                        <td><img src="{{ url('/') }}/images/{{ $item->imageFileName }}" width='50px' height='50px' class="img-thumbnail"></td>
                                        <td>
