...
class BonusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('bonus')->with('flash_message', 'Bonu added!');
    }
    ...
    public function show($id)
    {
        ...
        return view('bonus.show', compact('bonu'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('bonus.edit', compact('bonu'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('bonus')->with('flash_message', 'Bonu updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('bonus')->with('flash_message', 'Bonu deleted!');
    }
}
